...
/*----------------- 2023-1 ----------------------------------*/
/*----------------- Equipo: 3 ------------------------------*/
/*----------------- Alumnos: Aguirre Ramírez Leonardo ------*/
/*----------------- Luna Villaseñor Ángel David --*/
/*----------------- Montiel Moreno Oscar --------*/
...
// camera
Camera camera(glm::vec3(0.0f, 100.0f, 290.0f));
...
void animate(void)
{
    ...
    lightPosition.x = 500.0f * cos(miVariable);
    lightPosition.y = 600.0f * sin(miVariable);
    miVariable += 0.01f;
...
int main()
{
    ...
    {
        "resources/skybox/proy/+z.jpg", //bien
        "resources/skybox/proy/-z.jpg",
        "resources/skybox/proy/+y.jpg", //bien
        "resources/skybox/proy/-y.jpg", //bien
        "resources/skybox/proy/-x.jpg", //bien
        "resources/skybox/proy/+x.jpg"
    };
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        staticShader.setVec3("dirLight.ambient", glm::vec3(0.0f, 0.0f, 0.0f));	//aquí prendo y apago luz direccionañ
        ...
        staticShader.setVec3("pointLight[1].ambient", glm::vec3(0.0f, 0.0f, 0.0f)); //(Crojo, Cazul, Cverde));
        ...
        staticShader.setVec3("pointLight[2].position", glm::vec3(130.0, 4.0f, 270.0f));	//fuente de luz posicional 3
        staticShader.setVec3("pointLight[2].ambient", glm::vec3(0.0f, encender, encender));		
        staticShader.setVec3("pointLight[2].diffuse", glm::vec3(0.7f, 1.0f, 0.6f));		
